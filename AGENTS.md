...
This file orients a coding agent (Claude Code, Codex, Copilot) working in this repo. Read it before making changes.
...
```bash
make reload   # build + ad-hoc sign + re-bootstrap launchd
...
1. ✅ Ops hygiene: logs, Info.plist, codesign, AGENTS.md
